...
class TopRing(QWidget):
    ...
    def __init__(self, master, mosaicClient, controller, light_instance_ref, logger, main_app_instance=None):
        ...
        self.light_group_name = "Top Ring [Outside]"
        self.name = "Top Ring"
        ...
        initial_brightness = self.light_instance_ref.saved_slider_values.get("Top Ring Outside Brightness", 3)
        initial_color_code = self.light_instance_ref.saved_slider_values.get("Top Ring Outside Color Code", "W")
        initial_color_name = self.light_instance_ref.saved_slider_values.get("Top Ring Outside Color Name", "White")
        ...
        self.light_instance_ref.register_slider("Top Ring [Outside]", self.slider)
    ...
    def _update_and_send_udp(self, slider_value):
        ...
        try:
            ...
            print(f"NETWORK ERROR in TopRing page: Could not send UDP message. {e}")
